...
// создание анонимной функции приравнивают переменной
...
// sum(1, 2);
// sum('hello', 'world');   // вызываем функцию - выведет helloworld
...
function myFunc6(a) {
  if (a > 6) {
    return ">6"; // вернем строку больше 6
  } else {
    return "<6";// выведет <6 потому что при вызове мы ввели единицу
  }
}
...
// самовызывающаяся функция одноразовая, нельзя вызвать из других мест
// (function () {
...
// визуально что происходит когда создаем переменные через var
function myFunc7() {
  var a;
  var b;
  var lastName;

  console.log(a); // вывело 10
